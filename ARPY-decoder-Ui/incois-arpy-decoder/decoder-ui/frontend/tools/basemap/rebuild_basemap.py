...
SRC = os.environ.get("BASEMAP_SRC", "/home/user/uploads/image-1.png")
OUT = os.environ.get("BASEMAP_OUT", str(pathlib.Path(__file__).resolve().parents[2] / "src/assets/fleet_basemap.jpg"))
P, X0, Hv = 819, 54, 758
